...
declare namespace contractTool {
    ...
    export type AbiVMType = 'bool' | 'i64' | 'u64' | 'f64' | 'string' | 'bytes' | 'address' | 'u256'
    export type AbiType = 'function' | 'event'

    export type AbiJSType = string | number | Uint8Array | ArrayBuffer | BN | boolean


    export type Numeric = string | number | BN
    ...
    export class RPC {
         ...
         * @param pkOrAddress 公钥、地址或者公钥哈希
         */
        getBalance(pkOrAddress: Binary): Promise<string | number>;
